...
def getData():
	...
	#query = 'SELECT FROM Checkin WHERE lat BETWEEN {} AND {} AND lng BETWEEN {} AND {} AND time BETWEEN {2014-07-01 12:10:02} AND {2014-09-27 19:10:40}'
        query = 'SELECT * FROM User WHERE lat BETWEEN {} AND {} AND lng BETWEEN {} AND {} AND followers > "100"'
